	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Leaf Now-Build 0.0.1</h2>
				<p>Your Product Our Platform</p>
				<br><br>
				<center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Leaf Now-Build 0.0.1 &copy; </h3>
			<!--<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Your product Our platform !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Leaf Now-Build 0.0.1 Fam<span>Vormir</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:compsoft@gmail.com" style="color:white">compsoft@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Leaf Now-Build 0.0.1</b></span>
				Leaf Now-Build 0.0.1 is encouraging users to sell/buy/donate plants/seeds...
			</p>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<!--<div class="row uniform">
			                        ...
			                        <div class="">
			                            <input type="radio" id="farmer" name="category" value="1"  disabled="false">
			                            <label for="farmer">Farmer</label>
			                        </div>
			                        <div class="">
			                            <input type="radio" id="buyer" name="category" value="0" disabled="false">
			                            <label for="buyer">Buyer</label>
			                        </div>
								</div>-->
								<div class="row uniform">
