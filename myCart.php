...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Leaf Now-Build 0.0.1: My Cart</title>
			...
			<section id="main" class="wrapper style1 align-center" >
				...
				<div class="container">
					...
					<div class="6u 12u$(large)">
                                        <!--<a href="buyNow.php?pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration:underline;"> Buy Now</a>-->
											 <a href="buyNow.php?pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration-thickness: 50%;"> Buy Now</a>
                                    </div>
